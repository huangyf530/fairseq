...
ROOT_DIR=/home/huangyufei/moe-fairseq/fairseq
cd $ROOT_DIR
DATA_DIR=$ROOT_DIR/data-bin/bert-corpus
SAVE_DIR=$ROOT_DIR/checkpoints/roberta-expert-test
...
mkdir -p $SAVE_DIR
python fariseq_cli/train.py --fp16 --fp16-init-scale 8 $DATA_DIR \
